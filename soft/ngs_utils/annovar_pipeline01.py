...
db_fn = "dkhg38_annot_genano.list"
...
for avinput_fn in glob.glob("idsc-*avinput"):
    for db_name in db_list:	
        ...
        #print out_fn
        command = '''../annovar_20190611/annotate_variation.pl -dbtype %s -build hg38 --outfile %s %s ../annovar_20190611/humandb/ ''' % (db_name, out_fn, avinput_fn)
        print command
        print
