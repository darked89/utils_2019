...
## 20190515 DK: located /DANE_SYNOLOGY/users/arek/Project_data/DoD_2015/GRIDSS/analysis/gridss.sh

INPUT=${1}
BLACKLIST=/opt/GRIDSS/hg38.blacklist.bed
REFERENCE=/opt/GRIDSS/hg38canon.fa
OUTPUT=${INPUT/.bam/.sv.vcf}
ASSEMBLY=${OUTPUT/.sv.vcf/.gridss.assembly.bam}
GRIDSS_JAR=/opt/GRIDSS/bin/gridss-1.4.1-jar-with-dependencies.jar
